...
// Tactile Minimal Navigation Menu — clean, solid surfaces, soft hover
...
const navigationMenuTriggerStyle = cva(
  [
    "group inline-flex h-9 w-max items-center justify-center rounded-[6px] px-4 py-2 text-sm font-medium",
