...
// Sharp Dark Empty State: centered content with icon, title, description, and optional action
// Uses rounded-[20px] bg-secondary/50 pattern from Sharp Dark's empty states
