    ...
    variants: {
      variant: {
        ...
        default:
          ...
          "shadow-[0_16px_8px_rgba(240,80,35,0.04),0_8px_6px_rgba(240,80,35,0.08),0_4px_4px_rgba(240,80,35,0.14),0_1.5px_3px_rgba(240,80,35,0.22),0_0_0_1px_rgba(180,50,10,0.85),inset_0_1px_2px_rgba(255,255,255,0.14)] " +
          "hover:shadow-[0_16px_8px_rgba(240,80,35,0.07),0_8px_6px_rgba(240,80,35,0.12),0_4px_4px_rgba(240,80,35,0.20),0_1.5px_3px_rgba(240,80,35,0.30),0_0_0_1px_rgba(180,50,10,0.9),inset_0_1px_2px_rgba(255,255,255,0.16)] " +
        ...
        outline:
          ...
          "hover:bg-primary/10 hover:shadow-[0_0_0_3px_rgba(240,80,35,0.12)] " +
          "focus-visible:shadow-[0_0_0_3px_rgba(240,80,35,0.18)] focus-visible:ring-2 focus-visible:ring-primary/40",
