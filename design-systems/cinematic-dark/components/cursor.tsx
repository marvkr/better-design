  ...
  return (
    <div className={cn("relative inline-flex flex-col gap-2", className)}>
      <AnimatePresence>
        {(isTyping || displayedText) && (
          <motion.div
            ...
            className="rounded-lg border border-border/40 bg-card/90 px-3.5 py-2.5 text-sm text-foreground shadow-lg shadow-black/20 backdrop-blur-sm"
      ...
      {label && (
        ...
        >
          <div
            className="h-2.5 w-2.5 rounded-full shadow-md shadow-black/30"
            style={{ backgroundColor: color }}
          />
