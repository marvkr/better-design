...
// Cinema Empty State: centered content with icon, title, description, and optional action
// Uses rounded-[20px] bg-secondary/50 pattern from Cinema's empty states
