...
// Midnight Glass Color Swatch: displays a color with glass border ring
    ...
    <div className={cn("flex flex-col items-center gap-1.5", className)} {...props}>
      <div
        className={cn(
          "rounded-full",
          sizeClasses[size],
          "ring-2 ring-white/[0.08] ring-offset-2 ring-offset-transparent",
          "shadow-[0_0_12px_rgba(255,255,255,0.05),inset_0_0_4px_rgba(255,255,255,0.1)]",
          "backdrop-blur-sm"
        )}
