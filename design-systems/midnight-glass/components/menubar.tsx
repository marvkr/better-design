...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus:bg-white/[0.07] focus:text-foreground",
      "data-[state=open]:bg-white/[0.07] data-[state=open]:text-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, inset, children, ...props }, ref) => (
  <MenubarPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-white/[0.07] data-[state=open]:bg-white/[0.07]",
      inset && "pl-8",
      className
    )}
    {...props}
