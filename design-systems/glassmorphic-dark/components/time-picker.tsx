...
// Glassmorphic Dark Time Picker: glass pill inputs for hours/minutes with AM/PM toggle
  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={disabled}
        className="ml-1 rounded-full px-1.5 py-0.5 text-xs font-medium text-white/50 transition-colors hover:bg-white/[0.08] hover:text-white/80 disabled:pointer-events-none"
      >
        {period}
      </button>
    </div>
