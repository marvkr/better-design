...
// Dynamic Typography: dark theme, vibrant accents on headings, clean Inter type
...
const H1 = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h1
      ref={ref}
      className={cn(
        "scroll-m-20 text-5xl font-bold tracking-tight text-foreground leading-[1.1]",
        className
      )}
      {...props}
    />
...
const H3 = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn(
        "scroll-m-20 text-2xl font-bold tracking-tight text-foreground leading-[1.25]",
        className
      )}
      {...props}
    />
...
const Code = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ({ className, ...props }, ref) => (
    <code
      ref={ref}
      className={cn(
        "block w-full rounded-xl border border-border bg-secondary/60 px-5 py-4",
        "font-mono text-sm text-foreground/90 leading-relaxed overflow-x-auto",
        className
      )}
      {...props}
    />
