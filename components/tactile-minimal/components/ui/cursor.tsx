...
// Tactile Minimal Cursor — typing animation with a blinking cursor.
// Flat card surface with soft border. No glass, no glow.
      ...
      <AnimatePresence>
        {(isTyping || displayedText) && (
          <motion.div
            ...
            className={cn(
              "rounded-[10px] border border-border bg-card px-3 py-2 text-sm text-card-foreground"
            )}
