...
// Midnight Glass Inline Edit: transparent by default, glass on edit
...
function InlineEdit({
    ...
    return (
      <div className={cn("flex items-center gap-1.5", className)}>
        <input
          ...
          className={cn(
            "h-10 min-w-0 flex-1 px-4 text-[15px]",
        ...
        <button
          ...
          className="flex h-7 w-7 items-center justify-center rounded-full border border-white/[0.08] backdrop-blur-xl bg-white/[0.05] text-white/50 transition-colors hover:bg-white/[0.08] hover:text-white/80"
        >
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "group flex items-center gap-1.5 rounded-full px-1 py-0.5 text-[15px]",
        "text-white/80 transition-colors hover:bg-white/[0.05]",
