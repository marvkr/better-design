...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
 "flex h-10 items-center gap-1 rounded-none p-1",
...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
 "flex cursor-default select-none items-center rounded-none px-3 py-1.5 text-sm font-medium outline-none",
 "transition-[background-color,color] duration-150",
 "focus:bg-accent focus:text-accent-foreground",
...
>(({ className, ...props }, ref) => (
 <MenubarPrimitive.SubContent ref={ref} className={cn(contentStyles, className)} {...props} />
))
