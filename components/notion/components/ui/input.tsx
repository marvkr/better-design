...
// Focus: blue ring color-mix(in_oklch,var(--primary)_35%,transparent), 100ms transition
    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:bg-white focus-visible:shadow-[0_0_0_2px_color-mix(in_oklch,var(--primary)_35%,transparent)]",
