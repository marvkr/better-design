...
const navigationMenuTriggerStyle = cva(
  [
    ...
    "focus:bg-white/[0.06] focus:text-foreground focus:outline-none",
    "disabled:pointer-events-none disabled:opacity-50",
    "data-[active]:bg-white/[0.08] data-[state=open]:bg-white/[0.08]",
    "data-[active]:shadow-[inset_0_0_8px_rgba(255,255,255,0.1)]",
  ].join(" ")
)
