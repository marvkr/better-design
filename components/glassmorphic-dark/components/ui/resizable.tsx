    ...
    {withHandle && (
      <div
        className={cn(
          ...
          "shadow-[0_0_8px_color-mix(in_oklch,var(--primary)_20%,transparent),inset_0_0_4px_rgba(255,255,255,0.06)]",
          "transition-all duration-200",
          "hover:bg-white/[0.16] hover:shadow-[0_0_12px_color-mix(in_oklch,var(--primary)_35%,transparent)]"
        )}
      >
