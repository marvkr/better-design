...
// Luxe Drawer: vaul drawer — rounded-t-xl, dark bg, subtle drag handle
// Slides up from bottom; card bg, border at top for separation
  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-t-xl border-t border-border/60 bg-card",
        "focus:outline-none",
        className
      )}
      {...props}
