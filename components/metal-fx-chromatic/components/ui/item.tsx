    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          interactive &&
            "cursor-pointer hover:bg-accent hover:[box-shadow:var(--shadow-m)] active:translate-y-px active:[box-shadow:var(--shadow-s)]",
          selected && "border-primary/40 bg-accent [box-shadow:var(--shadow-m)]",
          className
        )}
        {...props}
      />
