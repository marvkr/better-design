...
import {
  ...
  SonicPunchyButton, SonicGlassyButton, SonicWarmButton, SonicLofiButton, SonicAiryButton, SonicMetallicButton, SonicBrightButton, SonicOrganicButton, SonicRetroButton,
  ...
  SonicPunchyCard, SonicPunchyCardHeader, SonicPunchyCardTitle, SonicPunchyCardDescription, SonicPunchyCardContent, SonicPunchyCardFooter,
  SonicGlassyCard, SonicGlassyCardHeader, SonicGlassyCardTitle, SonicGlassyCardDescription, SonicGlassyCardContent, SonicGlassyCardFooter,
  SonicWarmCard, SonicWarmCardHeader, SonicWarmCardTitle, SonicWarmCardDescription, SonicWarmCardContent, SonicWarmCardFooter,
  SonicLofiCard, SonicLofiCardHeader, SonicLofiCardTitle, SonicLofiCardDescription, SonicLofiCardContent, SonicLofiCardFooter,
  SonicAiryCard, SonicAiryCardHeader, SonicAiryCardTitle, SonicAiryCardDescription, SonicAiryCardContent, SonicAiryCardFooter,
  SonicMetallicCard, SonicMetallicCardHeader, SonicMetallicCardTitle, SonicMetallicCardDescription, SonicMetallicCardContent, SonicMetallicCardFooter,
  SonicBrightCard, SonicBrightCardHeader, SonicBrightCardTitle, SonicBrightCardDescription, SonicBrightCardContent, SonicBrightCardFooter,
  SonicOrganicCard, SonicOrganicCardHeader, SonicOrganicCardTitle, SonicOrganicCardDescription, SonicOrganicCardContent, SonicOrganicCardFooter,
  SonicRetroCard, SonicRetroCardHeader, SonicRetroCardTitle, SonicRetroCardDescription, SonicRetroCardContent, SonicRetroCardFooter,
  ...
  SonicPunchyInput, SonicGlassyInput, SonicWarmInput, SonicLofiInput, SonicAiryInput, SonicMetallicInput, SonicBrightInput, SonicOrganicInput, SonicRetroInput,
  ...
  SonicPunchyBadge, SonicGlassyBadge, SonicWarmBadge, SonicLofiBadge, SonicAiryBadge, SonicMetallicBadge, SonicBrightBadge, SonicOrganicBadge, SonicRetroBadge,
  ...
  SonicPunchyCodeTabs, SonicGlassyCodeTabs, SonicWarmCodeTabs, SonicLofiCodeTabs, SonicAiryCodeTabs, SonicMetallicCodeTabs, SonicBrightCodeTabs, SonicOrganicCodeTabs, SonicRetroCodeTabs,
  ...
  SonicPunchyCursor, SonicGlassyCursor, SonicWarmCursor, SonicLofiCursor, SonicAiryCursor, SonicMetallicCursor, SonicBrightCursor, SonicOrganicCursor, SonicRetroCursor,
...
const BADGE_MAP: Record<string, AnyBadge> = {
  ...
  "sonic-punchy": SonicPunchyBadge as AnyBadge,
  "sonic-glassy": SonicGlassyBadge as AnyBadge,
  "sonic-warm": SonicWarmBadge as AnyBadge,
  "sonic-lofi": SonicLofiBadge as AnyBadge,
  "sonic-airy": SonicAiryBadge as AnyBadge,
  "sonic-metallic": SonicMetallicBadge as AnyBadge,
  "sonic-bright": SonicBrightBadge as AnyBadge,
  "sonic-organic": SonicOrganicBadge as AnyBadge,
  "sonic-retro": SonicRetroBadge as AnyBadge,
}
...
const CARD_MAP: Record<string, {
  ...
  "sonic-punchy": { Card: SonicPunchyCard as AnyCard, CardHeader: SonicPunchyCardHeader as AnyCardSub, CardTitle: SonicPunchyCardTitle as AnyCardSub, CardDescription: SonicPunchyCardDescription as AnyCardSub, CardContent: SonicPunchyCardContent as AnyCardSub, CardFooter: SonicPunchyCardFooter as AnyCardSub },
  "sonic-glassy": { Card: SonicGlassyCard as AnyCard, CardHeader: SonicGlassyCardHeader as AnyCardSub, CardTitle: SonicGlassyCardTitle as AnyCardSub, CardDescription: SonicGlassyCardDescription as AnyCardSub, CardContent: SonicGlassyCardContent as AnyCardSub, CardFooter: SonicGlassyCardFooter as AnyCardSub },
  "sonic-warm": { Card: SonicWarmCard as AnyCard, CardHeader: SonicWarmCardHeader as AnyCardSub, CardTitle: SonicWarmCardTitle as AnyCardSub, CardDescription: SonicWarmCardDescription as AnyCardSub, CardContent: SonicWarmCardContent as AnyCardSub, CardFooter: SonicWarmCardFooter as AnyCardSub },
  "sonic-lofi": { Card: SonicLofiCard as AnyCard, CardHeader: SonicLofiCardHeader as AnyCardSub, CardTitle: SonicLofiCardTitle as AnyCardSub, CardDescription: SonicLofiCardDescription as AnyCardSub, CardContent: SonicLofiCardContent as AnyCardSub, CardFooter: SonicLofiCardFooter as AnyCardSub },
  "sonic-airy": { Card: SonicAiryCard as AnyCard, CardHeader: SonicAiryCardHeader as AnyCardSub, CardTitle: SonicAiryCardTitle as AnyCardSub, CardDescription: SonicAiryCardDescription as AnyCardSub, CardContent: SonicAiryCardContent as AnyCardSub, CardFooter: SonicAiryCardFooter as AnyCardSub },
  "sonic-metallic": { Card: SonicMetallicCard as AnyCard, CardHeader: SonicMetallicCardHeader as AnyCardSub, CardTitle: SonicMetallicCardTitle as AnyCardSub, CardDescription: SonicMetallicCardDescription as AnyCardSub, CardContent: SonicMetallicCardContent as AnyCardSub, CardFooter: SonicMetallicCardFooter as AnyCardSub },
  "sonic-bright": { Card: SonicBrightCard as AnyCard, CardHeader: SonicBrightCardHeader as AnyCardSub, CardTitle: SonicBrightCardTitle as AnyCardSub, CardDescription: SonicBrightCardDescription as AnyCardSub, CardContent: SonicBrightCardContent as AnyCardSub, CardFooter: SonicBrightCardFooter as AnyCardSub },
  "sonic-organic": { Card: SonicOrganicCard as AnyCard, CardHeader: SonicOrganicCardHeader as AnyCardSub, CardTitle: SonicOrganicCardTitle as AnyCardSub, CardDescription: SonicOrganicCardDescription as AnyCardSub, CardContent: SonicOrganicCardContent as AnyCardSub, CardFooter: SonicOrganicCardFooter as AnyCardSub },
  "sonic-retro": { Card: SonicRetroCard as AnyCard, CardHeader: SonicRetroCardHeader as AnyCardSub, CardTitle: SonicRetroCardTitle as AnyCardSub, CardDescription: SonicRetroCardDescription as AnyCardSub, CardContent: SonicRetroCardContent as AnyCardSub, CardFooter: SonicRetroCardFooter as AnyCardSub },
}
...
const CODE_TABS_MAP: Record<string, AnyCodeTabs> = {
  ...
  "sonic-punchy": SonicPunchyCodeTabs as AnyCodeTabs,
  "sonic-glassy": SonicGlassyCodeTabs as AnyCodeTabs,
  "sonic-warm": SonicWarmCodeTabs as AnyCodeTabs,
  "sonic-lofi": SonicLofiCodeTabs as AnyCodeTabs,
  "sonic-airy": SonicAiryCodeTabs as AnyCodeTabs,
  "sonic-metallic": SonicMetallicCodeTabs as AnyCodeTabs,
  "sonic-bright": SonicBrightCodeTabs as AnyCodeTabs,
  "sonic-organic": SonicOrganicCodeTabs as AnyCodeTabs,
  "sonic-retro": SonicRetroCodeTabs as AnyCodeTabs,
}
...
const CURSOR_MAP: Record<string, AnyCursor> = {
  ...
  "sonic-punchy": SonicPunchyCursor as AnyCursor,
  "sonic-glassy": SonicGlassyCursor as AnyCursor,
  "sonic-warm": SonicWarmCursor as AnyCursor,
  "sonic-lofi": SonicLofiCursor as AnyCursor,
  "sonic-airy": SonicAiryCursor as AnyCursor,
  "sonic-metallic": SonicMetallicCursor as AnyCursor,
  "sonic-bright": SonicBrightCursor as AnyCursor,
  "sonic-organic": SonicOrganicCursor as AnyCursor,
  "sonic-retro": SonicRetroCursor as AnyCursor,
}
