...
export function Testimonial({ className, ...props }: ComponentProps<"figure">) {
  return <figure data-slot="testimonial" className={cn("flex h-full flex-col", className)} {...props} />
}
...
export function TestimonialAvatar({ className, ...props }: ComponentProps<"div">) {
  return <div data-slot="avatar" className={cn("relative row-span-2 size-8 shrink-0", className)} {...props} />
}
...
export function TestimonialAvatarRing({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("pointer-events-none absolute inset-0 rounded-full ring-1 ring-black/10 ring-inset dark:ring-white/15", className)}
      {...props}
    />
  )
}
...
export function TestimonialVerifiedBadge({ className, ...props }: ComponentProps<"svg">) {
  return (
    <svg
      ...
      className={cn("ml-1.5 inline-block size-3 -translate-y-px text-blue-500", className)}
